...
{
    lingeo::Vector_3D p1{3, 0, 0};
    lingeo::Vector_3D q1{0, 0, 1};
    lingeo::Vector_3D r1{0, 3, 0};

    lingeo::Vector_3D p2{4, 0, 0};
    lingeo::Vector_3D q2{0, 0, 2};
    lingeo::Vector_3D r2{0, 4, 0};
...
{
    lingeo::Vector_3D p1{2, 2, 0};
    lingeo::Vector_3D q1{0, -2, 0};
    lingeo::Vector_3D r1{-2, 0, 0};

    lingeo::Vector_3D p2{2, 2, 0};
    lingeo::Vector_3D q2{0, 6, 0};
    lingeo::Vector_3D r2{-2, 0, 0};
...
{
    lingeo::Vector_3D p2{0, 0, 0};
    lingeo::Vector_3D q2{2, -2, 0};
    lingeo::Vector_3D r2{2, 2, 0};

    lingeo::Vector_3D p1{0, 4, 0};
    lingeo::Vector_3D q1{1, -2, 0};
    lingeo::Vector_3D r1{6, 4, 0};
...
TEST(TriangleTriangle, R1_4_a_not_intsct)
{
    ...
    lingeo::Vector_3D p1{0, 4, 0};
    lingeo::Vector_3D q1{-2, -2, 0};
    lingeo::Vector_3D r1{-1, -1, 0};
...
TEST(TriangleTriangle, R1_5_not_intsct)
{
    ...
    lingeo::Vector_3D p1{-2, 2, 0};
    lingeo::Vector_3D q1{0, 1.61, 0};
    lingeo::Vector_3D r1{1.2, 8.35, 0};
...
TEST(TriangleTriangle, R1_5_intsct)
{
    ...
    lingeo::Vector_3D p1{-2, 2, 0};
    lingeo::Vector_3D q1{0, -2.08, 0};
    lingeo::Vector_3D r1{1.2, 4.66, 0};
...
TEST(TriangleTriangle, R1_2_a_not_intsct)
{
    ...
    lingeo::Vector_3D p1{-1.49, 2.33, 0};
    lingeo::Vector_3D q1{-2, 1, 0};
    lingeo::Vector_3D r1{-1, -1, 0};
...
TEST(TriangleTriangle, R1_3_b_not_intsct)
{
    ...
    lingeo::Vector_3D p1{-1.49, 2.33, 0};
    lingeo::Vector_3D q1{-2, 1, 0};
    lingeo::Vector_3D r1{2.42, 2.46, 0};
...
TEST(TriangleTriangle, R1_4_b_not_intsct)
{
    ...
    lingeo::Vector_3D p1{-1.49, 2.33, 0};
    lingeo::Vector_3D q1{-2, 1, 0};
    lingeo::Vector_3D r1{0.12, -0.51, 0};
...
TEST(TriangleTriangle, R2_4_a_intsct)
{
    lingeo::Vector_3D p2{0, 0, 0};
    lingeo::Vector_3D q2{2, -2, 0};
    lingeo::Vector_3D r2{2, 1, 0};

    lingeo::Vector_3D p1{2.75, 3.00, 0};
    lingeo::Vector_3D q1{2, -2, 0};
    lingeo::Vector_3D r1{1.94, -2.42, 0};
...
TEST(TriangleTriangle, R2_4_a_not_intsct)
{
    ...
    lingeo::Vector_3D p1{2.75, 3.00, 0};
    lingeo::Vector_3D q1{1.94, -2.42, 0};
    lingeo::Vector_3D r1{2.1, -2.67, 0};
...
TEST(TriangleTriangle, R2_4_b_not_intsct)
{
    ...
    lingeo::Vector_3D p1{2.75, 3.00, 0};
    lingeo::Vector_3D q1{-1.58, -1.32, 0};
    lingeo::Vector_3D r1{-0.91, -0.81, 0};
...
TEST(TriangleTriangle, R2_5_a_intsct)
{
    ...
    lingeo::Vector_3D p1{2.75, 3.00, 0};
    lingeo::Vector_3D q1{-1.58, -1.32, 0};
    lingeo::Vector_3D r1{2.94, 1.47, 0};
...
TEST(TriangleTriangle, R2_5_a_not_intsct)
{
    ...
    lingeo::Vector_3D p1{2.75, 3.00, 0};
    lingeo::Vector_3D q1{-1.58, -1.32, 0};
    lingeo::Vector_3D r1{1.9, 1.47, 0};
...
TEST(TriangleTriangle, R2_3_b_not_intsct)
{
    ...
    lingeo::Vector_3D p1{2.75, 3.00, 0};
    lingeo::Vector_3D q1{2.94, 1.47, 0};;
    lingeo::Vector_3D r1{4, 0, 0};
...
TEST(TriangleTriangle, R2_4_c_not_intsct)
{
    ...
    lingeo::Vector_3D p1{2.75, 3.00, 0};
    lingeo::Vector_3D q1{2.38, 0.55, 0};;
    lingeo::Vector_3D r1{2.2, 1.1, 0};
...
TEST(TriangleTriangle, R2_5_b_intsct)
{
    ...
    lingeo::Vector_3D p1{2.75, 3.00, 0};
    lingeo::Vector_3D r1{2.2, 1.1, 0};
    lingeo::Vector_3D q1{1.78, -2.85, 0};;
...
TEST(TriangleTriangle, R2_5_b_not_intsct)
{
    ...
    lingeo::Vector_3D p1{2.75, 3.00, 0};
    lingeo::Vector_3D r1{2.36, 1.18, 0};
    lingeo::Vector_3D q1{1.58, -7.02, 0};;
...
TEST(TriangleTriangle, R2_2_b_not_intsct)
{
    ...
    lingeo::Vector_3D p1{2.75, 3.00, 0};
    lingeo::Vector_3D r1{0.4, 2.61, 0};
    lingeo::Vector_3D q1{-0.67, 0.2, 0};;
...
TEST(TriangleTriangle, R2_4_d_not_intsct)
{
    ...
    lingeo::Vector_3D p1{2.75, 3.00, 0};
    lingeo::Vector_3D r1{-5.58, -4.17, 0};
    lingeo::Vector_3D q1{0.26, 1.68, 0};
...
TEST(TriangleTriangle, R2_4_d_intsct)
{
    ...
    lingeo::Vector_3D p1{2.75, 3.00, 0};
    lingeo::Vector_3D r1{2.63, -2.08, 0};
    lingeo::Vector_3D q1{0.26, 1.68, 0};
...
TEST(TriangleTriangle, R2_4_e_not_intsct)
{
    ...
    lingeo::Vector_3D p1{2.75, 3.00, 0};
    lingeo::Vector_3D r1{2.06, 2.17, 0};
    lingeo::Vector_3D q1{3.22, -1.51, 0};
...
TEST(TriangleTriangle, R2_5_c_not_intsct)
{
    ...
    lingeo::Vector_3D p1{2.75, 3.00, 0};
    lingeo::Vector_3D r1{1.73, -2.52, 0};
    lingeo::Vector_3D q1{2.44, 2.25, 0};
...
TEST(TriangleTriangle, R1_4_b_intsct)
{
    ...
    lingeo::Vector_3D p1{-1.49, 2.33, 0};
    lingeo::Vector_3D q1{-2, 1, 0};
    lingeo::Vector_3D r1{0.14, -0.22, 0};
...
{
    lingeo::Vector_3D p1{29.3505, 805.295, 397.635};
    lingeo::Vector_3D q1{-248.565, -404.623, -873.618};
    lingeo::Vector_3D r1{-386.796, -76.4378, -878.078};

    lingeo::Vector_3D p2{-120.028, -992.064, 12.6612};
    lingeo::Vector_3D q2{-729.661, -244.151, -979.961};
    lingeo::Vector_3D r2{997.444, 982.96, -259.114};
